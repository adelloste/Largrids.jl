...
G1 = L.Struct([  g, L.r(pi/2,0,0) + A(interval),  g , L.r(0,pi/2,0), g , L.r(0,0,pi/2), L.s(-1,-1,-1), g , 
		L.t(2,0,0), L.r(pi/2,0,0),  g , L.t(0,0,2), L.r(0,pi/2,0), L.s(-1,-1,-1), g ]);
...
W,EW,FW,FE = Lar.chaincongruence(V, Delta_0, Delta_1, epsilon=0.1);
